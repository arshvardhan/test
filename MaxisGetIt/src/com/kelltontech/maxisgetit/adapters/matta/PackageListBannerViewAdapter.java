...
public class PackageListBannerViewAdapter extends FragmentPagerAdapter {

	private ArrayList<PackageListBanner> bannerList;
	private String mFlowFrom;
	private	Context mcontext;

	public PackageListBannerViewAdapter(FragmentManager fm, ArrayList<PackageListBanner> bannerList, Context context , String flowFrom) {
		super(fm);
