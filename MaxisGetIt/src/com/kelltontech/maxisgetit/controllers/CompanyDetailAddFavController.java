...
public class CompanyDetailAddFavController extends BaseServiceController {
	private Context mActivity;

	public CompanyDetailAddFavController(IActionController screen, int eventType) {
	...
	public void requestService(Object requestData) {
		...
		try {
			...
			logRequestException(e, "CompanyDetailAddFavController");
	...
	public void responseService(Object object) {
		...
		if (response.isError()) {
			...
			try {
				...
				logResponseException(e, "CompanyDetailAddFavController");
			}
