...
public class MyAccountDashboardController extends BaseServiceController {
		private Activity mActivity;
		public MyAccountDashboardController(IActionController screen, int eventType) {
		...
		public void requestService(Object requestData) {
			FavCompanyListRequest favCompanyListRequest = (FavCompanyListRequest)requestData;
			try {
				...
				Hashtable<String, String> urlParams = genralRequest.getHeadersWithUID(favCompanyListRequest.getUserId(), AppConstants.MyAccount);
				...
				String url = AppConstants.BASE_URL + GenralRequest.MY_ACCOUNT_DASHBOARD;
				Log.d("maxis", "url " + url);
				...
				logRequestException(e, "MyDashBoardController");
		...
		public void responseService(Object object) {
			...
			if (object instanceof Response) {
				try {
					...
					MyAccountDashboardResponse dashboardResponse = jsonParser.mapFromJSON(
							responseStr, MyAccountDashboardResponse.class);
