...
import com.kelltontech.maxisgetit.parsers.PostDealCityLocalityListParser;
...
public class PostDealCityLocalityListController extends BaseServiceController {
	...
	public void requestService(Object requestData) {
		try {
			...
			logRequestException(e, "PostDealCityLocalityListController");
