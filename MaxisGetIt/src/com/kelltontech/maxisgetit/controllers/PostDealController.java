...
public class PostDealController extends BaseServiceController {
	private Context mActivity;

	public PostDealController(IActionController screen, int eventType) {
	...
	public void requestService(Object requestData) {
		...
		try {
			...
			logRequestException(e, "PostDealController");
	...
	public void responseService(Object object) {
		...
		if (response.isError()) {
			...
			try {
				...
				logResponseException(e, "PostDealController");
			}
