...
public class RemovePostDealImgController extends BaseServiceController {

	private Context mActivity;

	public RemovePostDealImgController(IActionController screen, int eventType) {
	...
	public void requestService(Object requestData) {
		try {
			...
			String url = AppConstants.BASE_URL
					+ GenralRequest.REMOVE_POST_IMAGE_METHOD;
			Log.d("maxis", "url " + url);
			...
			logRequestException(e, "RemovePostDealImgController");
	...
	public void responseService(Object object) {
		...
		if (response.isError()) {
			...
			try {
				response.setPayload(new GenralResponseParser().parse(response
						.getResponseText()));
			} catch (Exception e) {
				logResponseException(e, "RemovePostDealImgController");
			}
