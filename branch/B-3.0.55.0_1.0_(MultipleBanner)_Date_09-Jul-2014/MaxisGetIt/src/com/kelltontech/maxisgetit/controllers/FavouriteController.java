...
public class FavouriteController extends BaseServiceController {
	private Activity mActivity;
	public FavouriteController(IActionController screen, int eventType) {
	...
	public void requestService(Object requestData) {
		...
		try {
			...
			Hashtable<String, String> urlParams = genralRequest.getHeadersWithUIDandPageNo(favCompanyListRequest.getUserId(), favCompanyListRequest.getPageNumber()+"");
			...
			String url = AppConstants.BASE_URL + GenralRequest.FAV_COMP_LIST;
			Log.d("maxis", "url " + url);
			...
			logRequestException(e, "FavCompanyController");
	...
	public void responseService(Object object) {
		...
		if( ! response.isError() ) {
			try {
				...
				handleException(e);
				logResponseException(e, "FavCompanyController");
				return;
			}
		}
