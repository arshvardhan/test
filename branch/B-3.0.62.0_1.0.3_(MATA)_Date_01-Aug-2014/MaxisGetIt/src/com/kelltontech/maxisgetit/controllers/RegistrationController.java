...
public class RegistrationController extends BaseServiceController {
	private Context mActivity;

	public RegistrationController(IActionController screen, int eventType) {
	...
	public void requestService(Object requestData) {
		try {
			...
			String url = AppConstants.BASE_URL + regRquest.getMethodName();
			Log.d("maxis", "url " + url);
			...
			logRequestException(e, "RegistrationController");
	...
	public void responseService(Object object) {
		...
		if (response.isError()) {
			...
			try {
				...
				logResponseException(e, "RegistrationController");
			}
