...
public interface DBManifest {
	...
	// TODO : can we make to go with single but 2-D array....
	 String[] TABLE_NAMES= new String[]{CityTable.TABLE_NAME, FavCompanysTable.TABLE_NAME};
	 String[] CREATE_QUERIES= new String[]{CityTable.CREATE_QUERY, FavCompanysTable.CREATE_QUERY};
