...
//	private boolean isSearchRefined;
	...
	/*public MattaBoothListRequest(Parcel in) {
...
//		ht.put(MaxisBaseRequest.KEY_LONGITUDE, "101.6880963379");
	...
	public static final Creator<MattaBoothListRequest> CREATOR = new Creator<MattaBoothListRequest>() {

		@Override
		public MattaBoothListRequest createFromParcel(Parcel source) {
			return new MattaBoothListRequest(source);
		}

		@Override
		public MattaBoothListRequest[] newArray(int size) {
			return new MattaBoothListRequest[size];
		}
	};

	public MattaBoothListRequest(Context context) {
