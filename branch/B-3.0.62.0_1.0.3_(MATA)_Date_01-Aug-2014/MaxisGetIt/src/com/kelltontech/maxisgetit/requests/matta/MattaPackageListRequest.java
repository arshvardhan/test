...
public class MattaPackageListRequest implements Serializable {
	...
	public MattaPackageListRequest(Parcel in) {
...
//		ht.put(MaxisBaseRequest.KEY_LONGITUDE, "101.6880963379");
	...
	public static final Creator<MattaPackageListRequest> CREATOR = new Creator<MattaPackageListRequest>() {

		@Override
		public MattaPackageListRequest createFromParcel(Parcel source) {
			return new MattaPackageListRequest(source);
		}

		@Override
		public MattaPackageListRequest[] newArray(int size) {
			return new MattaPackageListRequest[size];
		}
	};

	public MattaPackageListRequest(Context context) {
