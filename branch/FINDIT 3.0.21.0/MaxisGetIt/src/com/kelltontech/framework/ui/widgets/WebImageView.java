...
package com.kelltontech.framework.ui.widgets;
...
import com.kelltontech.framework.imageloader.ImageLoaderHandler;
...
public class WebImageView extends ViewSwitcher {
	 ...
	 *            manually trigger the image download.
	 */
	public WebImageView(Context context, String imageUrl, Drawable progressDrawable, Drawable errorDrawable, boolean autoLoad) {
		super(context);
	...
	public WebImageView(Context context, AttributeSet attributes) {
		...
		int progressDrawableId = attributes.getAttributeResourceValue(C.XMLNS, "progressDrawable", 0);
		int errorDrawableId = attributes.getAttributeResourceValue(C.XMLNS, "errorDrawable", 0);
		...
		initialize(context, attributes.getAttributeValue(C.XMLNS, "imageUrl"), progressDrawable, errorDrawable, attributes.getAttributeBooleanValue(C.XMLNS, "autoLoad", true));
		// styles.recycle();
	}
