...
public class UiUtils {
	...
	public static Bitmap createReflectedImages(Context context, Bitmap originalImage) {
		...
		LinearGradient shader = new LinearGradient(0, originalImage.getHeight(), 0, bitmapWithReflection.getHeight(), 0x70000000, 0x00ffffff, TileMode.CLAMP);
	...
	public static float getResolution(Context activity) {
		...
		if (_ScreenWidth <= 240) {
			/*
			 * _ScreenWidth = 240; _ScreenHeight = 432;
			 */
			res = 1;
		} else if (_ScreenWidth < 400) {
			/*
			 * _ScreenWidth = 320; _ScreenHeight = 480;
			 */
			res = 1;
		} else if (_ScreenWidth > 400 && _ScreenWidth <= 600) {
			/*
			 * _ScreenWidth = 480; _ScreenHeight = 854;
			 */
			res = 1.5f;
		} else {
			/*
			 * _ScreenWidth = 720; _ScreenHeight = 1184;
			 */
			res = 2;
		}
	...
	public static float getDeviceDensity(Activity activity) {
		 ...
		 * ().getDefaultDisplay().getMetrics(_Displaymetrics);
		 */
