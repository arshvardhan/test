...
public class ForgetPasswordController extends BaseServiceController {
	
	private Context mActivity;
	
	public ForgetPasswordController(IActionController screen, int eventType) {
	...
	public void requestService(Object requestData) {
		try{
			...
			String url = AppConstants.BASE_URL + GenralRequest.FORGET_PASSWORD;
			Log.d("maxis", "url " + url);
			...
			logRequestException(e, "ForgetPasswordController");
	...
	public void responseService(Object object) {
		...
		if (response.isError()) {
			...
			try {
				...
				logResponseException(e, "ForgetPasswordController");
			}
