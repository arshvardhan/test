...
public class CompanyListParser extends AbstractSAXParser {
	...
	public void onStartElement(String namespaceURI, String localName,
		...
		if (localName.equalsIgnoreCase(COMPANY_ROOT)
				|| localName.equalsIgnoreCase(DEAL_ROOT)
				|| localName.equalsIgnoreCase(DEAL_ROOT2)) {
	...
	public void onEndElement(String namespaceURI, String localName, String qName)
		...
		if (localName.equalsIgnoreCase(COMPANY_ROOT)
			...
			clResponse.setPageNumber(getInt(getNodeValue(), 0));
				...
				&& (parent.equalsIgnoreCase("Results,Company") || parent
						.equalsIgnoreCase("Results," + DEAL_ROOT))) {
		 ...
		 */else if (localName.equalsIgnoreCase(LATITUDE)) {
			...
			if (category != null
					&& !StringUtil.isNullOrEmpty(category.getCategoryId())
					&& !StringUtil.isNullOrEmpty(category.getCategoryTitle()))
				clResponse.addCategory(category);
		} else if (localName.equalsIgnoreCase(ID)
				&& parent.equalsIgnoreCase("Results,Categories,Category")) {
