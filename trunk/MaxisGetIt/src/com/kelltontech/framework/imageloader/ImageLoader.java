...
import com.kelltontech.framework.cachefu.ImageCache;
import com.kelltontech.framework.imageloader.ImageDownloaderGoogle.FlushedInputStream;
import com.kelltontech.framework.ui.widgets.WebImageView;
...
//	 */
//	public static void start(String imageUrl, ImageView imageView, Drawable dummyDrawable, Drawable errorDrawable, int reqWidth, int reqHeight) {
//		start(imageUrl, imageView, new ImageLoaderHandler(imageView, imageUrl, errorDrawable), dummyDrawable, errorDrawable, reqWidth, reqHeight);
//	}
//
//	public static void start(String imageUrl, ImageView imageView, Drawable dummyDrawable, Drawable errorDrawable) {
//		start(imageUrl, imageView, new ImageLoaderHandler(imageView, imageUrl, errorDrawable), dummyDrawable, errorDrawable, 0, 0);
//	}
//
//	/**
...
//	}
//
//	public static void start(String imageUrl, ImageView imageView, ImageLoaderHandler handler, Drawable dummyDrawable, Drawable errorDrawable, int reqWidth, int reqHeight) {
//		if (imageView != null) {
//			if (imageUrl == null || imageUrl.trim().equals("")||imageUrl.trim().length()<6) {
//				// In a ListView views are reused, so we must be sure to remove
//				// the tag that could
//				// have been set to the ImageView to prevent that the wrong
//				// image is set.
...
//			inputStream.close();
//		} else {
//			reqWidth = (int) (UiUtils.getResolution(mContext) * reqWidth);
//			reqHeight = (int) (UiUtils.getResolution(mContext) * reqHeight);
...
//				imageView.setBackgroundDrawable(dummyDrawable);
				imageView.setImageDrawable(dummyDrawable);
//				imageView.setImageDrawable(new BitmapDrawable(((BitmapDrawable)dummyDrawable).getBitmap()));
				imageView.setTag(imageUrl);
			}
		}
