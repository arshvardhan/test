...
public class AdPostNotificaitonActivity extends MaxisMainActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mInfoTextView.setText(getIntent().getStringExtra(AppConstants.NOTIFICATION_TEXT));
	...
	public void onClick(View v) {
		...
		case R.id.goto_home_icon:
			...
			Intent intentHome = new Intent(AdPostNotificaitonActivity.this, HomeActivity.class);
