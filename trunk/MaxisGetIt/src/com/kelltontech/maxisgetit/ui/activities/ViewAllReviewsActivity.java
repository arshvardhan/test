	...
	public void onClick(View v) {
		...
		case R.id.currentCity:
			if (cityListString != null && cityListString.size() > 0) {
				...
				Intent cityIntent = new Intent(ViewAllReviewsActivity.this, AdvanceSelectCity.class);
		...
		case R.id.currentLocality:
			if (localityItems != null && localityItems.size() > 0) {
				Intent localityIntent = new Intent(ViewAllReviewsActivity.this, AdvanceSelectLocalityActivity.class);
	...
	public void updateUI(Message msg) {
		if (msg.arg2 == Events.COMBIND_LISTING_NEW_LISTING_PAGE||msg.arg2==Events.USER_DETAIL) {
			...
			if (msg.arg1 == 1) {
				...
				Intent intent = new Intent(ViewAllReviewsActivity.this, AdvanceSelectCity.class);
			...
			if (msg.arg1 == 1) {
				...
				Intent intent = new Intent(ViewAllReviewsActivity.this, AdvanceSelectLocalityActivity.class);
